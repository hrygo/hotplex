...
| D03 | [Codex排队写入未绑定进程传输快照](D03-codex-transport-generation.md) | Test，修复通过；`fix/987-d03-codex-transport-generation` |
| D04 | [Codex旧进程清理和空闲回收与新Acquire交错](D04-codex-process-retirement.md) | Test，修复通过；`fix/987-d04-codex-process-retirement` |
...
| D09 | [Codex启动接受缺少原生线程或轮次ID的响应](D09-codex-lifecycle-response-validation.md) | Test，修复通过；`fix/987-d09-codex-lifecycle-response-validation` |
